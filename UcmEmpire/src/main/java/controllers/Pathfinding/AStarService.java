...
public class AStarService {
    ...
    private int calculDistance(Position p1, Position p2) {
...
//        }
    ...
    private void addToList(Position actual, Position adj) {
        if (!closedList.containsKey(adj)) {
            ...
            tmp.cout_g = closedList.get(actual).cout_g + calculDistance(adj, actual);

            /* calcul du cout H du noeud à la destination */
            tmp.cout_h = calculDistance(adj, actual);
